...
class Ion_auth_model extends CI_Model
{
	...
	public function get_ads_profil_seller($id)
  {
    $this->db->join('produk', 'users.id = produk.uploader');
    $this->db->where('username', $id);
    return $this->db->get('users');
  }

	public function get_profil_seller($id)
  {
    $this->db->where('username', $id);
    return $this->db->get('users');
  }
	...
	public function login($identity, $password, $remember=FALSE){
		...
		$query = $this->db->select($this->identity_column . ', email, id, nama, password, usertype, active, last_login')
		                  ->where($this->identity_column, $identity)
		                  ->where_not_in('usertype', 'user')
		                  ->limit(1)
		    			  			->order_by('id', 'desc')
		                  ->get($this->tables['users']);
	...
	public function username_check_front($username = ''){
		$this->trigger_events('username_check');
	...
	public function del_by_id($id)
  {
	...
	public function update_group($id_group, $data)
  {
		$this->db->where('id_group', $id_group);
  ...
  public function delete_group($id_group)
  {
	...
	public function login_remembered_user(){
		...
		// get the user
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column.', id, nama, usertype, email, last_login')
