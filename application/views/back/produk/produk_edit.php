              ...
              <li><?php echo $module ?></li>
                ...
                <?php echo form_open_multipart($action);?>
                  ...
                  <div class="form-group"><label>Harga</label>
                    <?php echo form_input($harga, $produk->harga);?>
                  </div>
                  <div class="row">
                    <div class="col-lg-4"><label>Kategori</label>
                      <?php echo form_dropdown('',$ambil_kategori,$produk->kat_id,$kat_id);?>
                    </div>
                    <div class="col-lg-4"><label>SubKategori</label>
                      <?php echo form_dropdown('',$ambil_subkat,$produk->subkat_id,$subkat_id);?>
                    </div>
                    <div class="col-lg-4"><label>SuperSubKategori</label>
                      <?php echo form_dropdown('',$ambil_supersubkat,$produk->supersubkat_id,$supersubkat_id);?>
                    </div>
                  </div><br>
