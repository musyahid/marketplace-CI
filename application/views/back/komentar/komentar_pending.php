        ...
        <table id="datatable" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php 
              echo anchor(site_url('admin/komentar/terima/'.$komentar_pending->id_komentar),'<i class="glyphicon glyphicon-ok"></i>','title="Terima", class="btn btn-sm btn-warning"'); echo ' ';
