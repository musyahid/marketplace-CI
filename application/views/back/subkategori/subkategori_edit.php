                ...
                <?php echo form_open($action);?>
                  ...
                  <div class="box-body">
                    <div class="form-group"><label>Judul Kategori</label>
                      <?php echo form_dropdown('',$ambil_kategori,$subkategori->id_kat,$kat_id);?>
                    </div>
                    <div class="form-group"><label>Judul SubKategori</label>
                      <?php echo form_input($judul_subkategori, $subkategori->judul_subkategori);?>
                    </div>
                  </div>
                  <?php echo form_input($id_subkat,$subkategori->id_subkategori);?>
                  <hr>
